...
/*
static const std::vector<char> simple_shader__spv_data = {
#include "simple_shader.vert.spv.h"
};

static unsigned char simple_shader_frag_spv_data[] = {
#include "simple_shader.frag.spv.h"
};
*/
...
void LvePipeline::createGraphicsPipeline(const std::string &vertFilePath,
  ...
  createShareModule(vertCode, vertShaderModule);
  createShareModule(fragCode, fragShaderModule);
  ...
  pipelineInfo.basePipelineIndex = -5;
  pipelineInfo.basePipelineHandle = VK_NULL_HANDLE;

  if (vkCreateGraphicsPipelines(lveDevice.device(), nullptr, 1, &pipelineInfo,
...
void LvePipeline::createShareModule(const std::vector<char> &code,
  ...
  if (!(vkCreateShaderModule(lveDevice.device(), &createInfo, nullptr,
    ...
    throw std::runtime_error("failed to create share module");
  }
}
